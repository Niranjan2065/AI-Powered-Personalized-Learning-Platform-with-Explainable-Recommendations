...
const s = {
  card:     { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)', padding: '1.25rem', marginBottom: 12, transition: 'box-shadow .15s' },
  ...
  qText:    { fontSize: 15, fontWeight: 600, lineHeight: 1.5, marginBottom: 12, color: 'var(--text-primary)' },
  opt:      (correct) => ({
    display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px',
    borderRadius: 8, marginBottom: 6, fontSize: 13,
    background: correct ? 'var(--secondary-light)' : 'var(--bg)',
    border: `1px solid ${correct ? 'var(--secondary)' : 'var(--border)'}`,
    color: correct ? 'var(--secondary)' : 'var(--text-secondary)',
    fontWeight: correct ? 600 : 400,
  }),
  dot:      (correct) => ({
    width: 16, height: 16, borderRadius: '50%', flexShrink: 0,
    background: correct ? 'var(--secondary)' : 'var(--border-dark)',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    fontSize: 9, color: '#fff',
  }),
  explain:  { fontSize: 12, color: 'var(--text-secondary)', marginTop: 10, padding: '8px 12px',
              background: 'var(--primary-light)', borderRadius: 8, borderLeft: '3px solid var(--primary)' },
  editArea: { width: '100%', fontSize: 14, padding: '8px 12px', borderRadius: 8,
              border: '1px solid var(--border-dark)', fontFamily: 'inherit', resize: 'vertical',
              marginBottom: 8, boxSizing: 'border-box', background: 'var(--surface)', color: 'var(--text-primary)' },
  editInput:{ width: '100%', fontSize: 13, padding: '7px 10px', borderRadius: 7,
              border: '1px solid var(--border-dark)', fontFamily: 'inherit', marginBottom: 6, boxSizing: 'border-box', background: 'var(--surface)', color: 'var(--text-primary)' },
  ...
  cancelBtn:{ padding: '7px 16px', fontSize: 13, borderRadius: 7,
              border: '1px solid var(--border-dark)', background: 'var(--surface)', color: 'var(--text-secondary)', cursor: 'pointer', marginRight: 8 },
};
